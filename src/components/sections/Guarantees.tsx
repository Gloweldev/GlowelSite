  ...
  const guarantees = [
    {
      ...
      description:
        "Si no estás completamente satisfecho con el resultado, trabajamos hasta que lo estés. Sin preguntas.",
      details: [
        "Revisión ilimitada",
    ...
    },
    {
      ...
      description:
        "Nos comprometemos a entregar tu proyecto en el plazo acordado. Si hay retrasos, te compensamos.",
      details: [
        "Cronograma claro",
        "Entregas parciales",
    ...
    },
    {
      ...
      description:
        "3 meses de soporte técnico gratuito después de la entrega. Tu proyecto siempre funcionará perfectamente.",
      details: [
        "Soporte 24/7",
    ...
    },
    {
      ...
      description:
        "Código limpio, documentado y con las mejores prácticas. Tu proyecto será escalable y mantenible.",
      details: [
        "Código documentado",
        "Mejores prácticas",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-slate-600 leading-relaxed">
            Trabajamos con total transparencia y te garantizamos resultados que
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-white to-green-50 rounded-3xl p-10 shadow-xl border border-slate-200/50 backdrop-blur-sm">
            ...
            <p className="text-slate-600 mb-8 max-w-2xl mx-auto text-lg">
              Iniciamos tu proyecto con total confianza. Si no estás satisfecho,
              trabajamos hasta que lo estés.
            </p>
            <a
